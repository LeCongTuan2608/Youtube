...
const url = 'https://youtube.googleapis.com/youtube/v3/search?f';
...
function search() {
   ...
   fetch(url + parameter + '&q=' + KeyWord.value + '&key=' + apiKey)
      ...
      .catch(function (err) {
         Contents_video.removeChild(Contents_video);
         let out = `<h3>Có lỗi khi call api!!</h3>`;
         Contents_video.insertAdjacentHTML('beforeend', out);
      });
}
