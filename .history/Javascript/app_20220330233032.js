...
async function get_Id_Title() {
   ...
   let lenght_list = Contents.length;
   console.log(lenght_list);
   console.log(Contents);
   for (let j = 0; j < lenght_list; j++) {
       Contents[j].onclick = function () {
         ...
         if (Contents[j].getAttribute('number') == Index) {
            ...
            Id_Video_Watch.push(getID);
            console.log(Id_Video_Watch);
            return await Id_Video_Watch;
         }
      };
   }
}
