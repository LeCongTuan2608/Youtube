...
const body_set_color = document.querySelector('body');
console.log(body_set_color);
...
btn_set_color.addEventListener('click', () => {
   if (Menu_Click) {
      ...
      body_set_color.setAttribute('class', '.body-set-color');
      Menu_Click = false;
   } else {
      header_child.setAttribute('class', 'container-header-child');
      body_set_color.setAttribute('class', 'body');
      Menu_Click = true;
   }
});
