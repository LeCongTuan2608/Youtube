...
import { Id_Video_Watch, Title_Watch } from './app.js';
console.log(Id_Video_Watch, Title_Watch);
console.log(Title_Watch);
...
function Video_Watching() {
   ...
   Title_Video.removeChild(title);

   // import cái id của video vừa click vào đây ở bên app.js
   let src_video = 'https://www.youtube.com/embed/';
   let id = 'y576-ONm5II';
   console.log(src_video + id);
   let output = `
         <iframe
            class="iframe_cls"
            src="${src_video + id}"
