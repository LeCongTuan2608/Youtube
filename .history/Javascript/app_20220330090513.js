...
function Result(Array_Video) {
   ...
   let Length_Video = Array_Video.items.length;
   for (let i = 0; i < Length_Video; i++) {
      let Id_video = Array_Video.items[i].id.videoId;
      let Thumbnails = Array_Video.items[i].snippet.thumbnails.medium.url;
      let Title = Array_Video.items[i].snippet.title;
      let output = `
               <div class="container-body-content">
                  <a class="link index = ${i}" href="watch.html">
...
Result();
export const value = 'y576-ONm5II';
