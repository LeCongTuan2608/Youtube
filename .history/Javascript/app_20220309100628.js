...
const Content_Menu = document.querySelector(".position-left-menu-bar ul li a");
...
Btn_Menu.addEventListener("click", function() {
    ...
    if (Menu_Click) {
            ...
            Content_Menu.classList.add("menu_active");
...
// const Menu_icon_Active = document.querySelectorAll(".position-left-menu-bar ul li");

// Menu_icon_Active.addEventListener("click", function(){
//     let Length = Menu_icon_Active.length;
//     for (let i = 0; i < Length; i++) {
