...
const Menu_width = document.querySelector('.container-body-position-left-menu-width');
const header_child_1 = document.querySelector('.container-header-child-set-color');
Set_Color.addEventListener('click', () => {
   if (Menu_Click) {
      ...
      Length_Menu.setAttribute('class', 'container-body-position-left-set-color');
      Menu_width.setAttribute('class', 'container-body-position-left-menu-width-set-color');
      Menu_Click = false;
   } else {
      // header_child_1.setAttribute('class', 'container-header-child');
      // body_child.setAttribute('class', 'container-body-child');
      // Length_Menu.setAttribute('class', 'container-body-position-left');
      // Menu_width.setAttribute('class', 'container-body-position-left-menu-width');
      Menu_Click = true;
   }
});
