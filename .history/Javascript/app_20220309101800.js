...
const Menu_icon_Active = document.querySelector(".position-left-menu-bar ul li");
const Menu_icon_List = document.querySelectorAll(".position-left-menu-bar ul li");
console.log(Menu_icon_Active);

Menu_icon_Active.addEventListener("click", function(){
    let Length = Menu_icon_List.length;
    for (let i = 0; i < Length; i++) {
        Menu_icon_List.setAttribute("class", "active");
        
    }
    Menu_icon_Active.setAttribute("class", "active");
});
