...
let Id_Video_Watch = JSON.parse(localStorage.getItem('Id_Video_Watch'));
console.log(Array_Video);
console.log(Id_Video_Watch);
// import { Id_Video_Watch, Title_Video_Watch } from './app.js';
let getId_video = Id_Video_Watch;
let getTitle_Video_Watch = Title_Video_Watch;
console.log(getId_video);
console.log(getTitle_Video_Watch);
