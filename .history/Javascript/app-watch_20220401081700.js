...
const Channel_Video = document.querySelector('.channel-name');
function Video_Watching() {
   ...
   Channel_Video.removeChild(channel_music);
   ...
   Title_Video.insertAdjacentHTML('beforebegin', output_Title);
   Channel_Video.insertAdjacentHTML('beforebegin', output_Channel);
}
Video_Watching();
